        ...
        >
          <div className="flex h-full items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <Button
                  className="hidden md:inline-flex relative group overflow-hidden rounded-full"
                >
                  <motion.div
                ...
                <SheetContent side="right" className="w-80 bg-black/95 border-white/[0.08] backdrop-blur-2xl">
                  <nav className="flex flex-col gap-4 mt-8">
                    ...
                    <motion.div
                      ...
                      transition={{ delay: 0.3 }}
                    >
                      <Button variant="ghost" className="w-full justify-start text-white/70 hover:text-white hover:bg-white/[0.05] rounded-full">
                        Sign In
                      </Button>
                    </motion.div>
                    <motion.div
